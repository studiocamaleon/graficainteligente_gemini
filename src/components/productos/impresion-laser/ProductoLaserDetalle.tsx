...
export function ProductoLaserDetalle({
  isOpen,
  onClose,
  producto,
  onEdit,
  ...
  return (
    ...
    >
      <div className="px-6 py-4 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
              ...
              {producto.tecnologias[0].tintas && producto.tecnologias[0].tintas.length > 0 ? (
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {producto.tecnologias[0].tintas.map((tintaCodigo, index) => (
        ...
        <div>
          <h4 className="text-sm font-medium text-gray-500 mb-2">Caras Impresas</h4>
          <div className="flex flex-wrap gap-2">
