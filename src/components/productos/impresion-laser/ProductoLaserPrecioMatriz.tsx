...
import type { ProductoLaserPrecio, PrecioInput } from '../../../hooks/useProductosImpresionLaserPrecios';
import type { TintaInfo } from '../../../hooks/useAllProductosLaserPrecios';
...
export function ProductoLaserPrecioMatriz({
  productoId,
  productoNombre,
  medida,
  tinta,
    ...
    cantidades.forEach((cantidad) => {
      caras.forEach((cara) => {
        ...
        const precioExistente = preciosRelevantes.find(
          (p) => p.cantidad === cantidad && p.cara_impresa === cara
        );
