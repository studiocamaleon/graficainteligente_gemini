...
import { useProductosMaterialesRigidos, useProductoMaterialesRigidos } from '../../../../hooks/useProductosMaterialesRigidos';
import { useConfirmDialog } from '../../../../hooks/useConfirmDialog';
import { ProductoMaterialesRigidosModal } from '../../../../components/productos/materiales-rigidos/ProductoMaterialesRigidosModal';
import { ProductoMaterialesRigidosDetalle } from '../../../../components/productos/materiales-rigidos/ProductoMaterialesRigidosDetalle';
import type { ProductoMaterialesRigidos, ProductoMaterialesRigidosConRelaciones } from '../../../../hooks/useProductosMaterialesRigidos';

interface ProductosMaterialesRigidosTabProps {
  triggerCreate?: number;
}

export function ProductosMaterialesRigidosTab({ triggerCreate = 0 }: ProductosMaterialesRigidosTabProps) {
  ...
  const handleVerDetalle = async (producto: ProductoMaterialesRigidos) => {
  ...
  const columns = [
    {
      key: 'nombre',
      header: 'Nombre',
      render: (producto: ProductoMaterialesRigidos) => (
    ...
    },
    {
      ...
      header: 'Tipo Venta',
      render: () => (
        <Badge variant="secondary">Por m²</Badge>
      ),
    },
    {
      key: 'impuesto',
  ...
  return (
    <>
            ...
            <EmptyState
              ...
              description={
                search || filterActive !== 'all'
                  ...
                  : 'Comienza creando tu primer producto de materiales rígidos'
              }
              action={
      ...
      <ProductoMaterialesRigidosModal
      ...
      {productoCompleto && (
        <>
          ...
          <ProductoMaterialesRigidosDetalle
