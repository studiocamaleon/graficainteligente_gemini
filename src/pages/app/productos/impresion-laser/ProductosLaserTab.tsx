...
import { useProductosImpresionLaser, useProductoImpresionLaser } from '../../../../hooks/useProductosImpresionLaser';
import { useConfirmDialog } from '../../../../hooks/useConfirmDialog';
import { ProductoLaserModal } from '../../../../components/productos/impresion-laser/ProductoLaserModal';
import { ProductoLaserDetalle } from '../../../../components/productos/impresion-laser/ProductoLaserDetalle';
import type { ProductoImpresionLaser, ProductoLaserConRelaciones } from '../../../../hooks/useProductosImpresionLaser';

interface ProductosLaserTabProps {
  triggerCreate?: number;
}

export function ProductosLaserTab({ triggerCreate = 0 }: ProductosLaserTabProps) {
  ...
  const columns = [
    {
      key: 'nombre',
      header: 'Nombre',
      render: (producto: ProductoImpresionLaser) => (
