...
export function WhatsAppIntegration() {
  ...
  // Verificar estado inicial y configuración
  useEffect(() => {
    if (companyId) {
      checkStatus();
      loadSettings();
  ...
  const loadSettings = async () => {
    ...
    try {
      ...
      setNotificationsEnabled(data.whatsapp_notifications_enabled || false);
    } catch (error) {
          ...
          <Card>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Estado actual de tu conexión con WhatsApp</p>
              </div>
            </div>
            <div className="space-y-6">
              {/* Estado actual */}
            ...
            <Card>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Preferencias de funcionamiento</p>
                </div>
              </div>

              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-start gap-3">
                  <div className={`mt-0.5 p-2 rounded-lg ${notificationsEnabled ? 'bg-green-100 text-green-600' : 'bg-gray-200 text-gray-500'}`}>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1 max-w-md">
                      Al activar esta opción, enviaremos mensajes automáticos a tus clientes cuando sus órdenes cambien de estado o se creen presupuestos.
                    </p>
                  </div>
                </div>
            ...
            <Card>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Enviá un mensaje de prueba para verificar la conexión</p>
                </div>
              </div>
