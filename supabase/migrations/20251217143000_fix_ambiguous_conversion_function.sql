-- =====================================================
-- FIX: Drop all overloads to resolve PGRST203
-- =====================================================

-- Drop the specific signatures identified in the error message to ensure clean slate
...
-- Drop generic to be safe (might fail if strictly typed parameters needed, but the above covers the conflict)

-- Re-create the Unified Function (Exact copy of intended logic)
