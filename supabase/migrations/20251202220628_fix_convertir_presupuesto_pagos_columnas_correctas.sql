/*
  # Fix: Corregir columnas en INSERT de ordenes_trabajo_pagos

  ## Problema
  La función intenta insertar columnas que no existen:
  - company_id (no existe)
  - registrado_por (debe ser created_by)
  - referencia (debe ser referencia_pago)

  ## Solución
  Actualizar el INSERT para usar las columnas correctas de ordenes_trabajo_pagos
*/
...
BEGIN
  ...
  -- Registrar pago inicial con columnas correctas
...
Versión final con todas las columnas correctas verificadas.';
