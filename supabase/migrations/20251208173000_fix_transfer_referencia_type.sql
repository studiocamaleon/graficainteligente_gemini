-- Migración para corregir violación de constraint "cajas_movimientos_referencia_tipo_check"
-- Valores permitidos: 'pago_orden', 'pago_copiado', 'gasto', 'transferencia', 'ajuste'
-- Se cambia 'transferencia_salida' y 'transferencia_entrada' por 'transferencia'
...
BEGIN
  ...
  INSERT INTO cajas_movimientos (
    caja_id,
    tipo_movimiento,
    monto, -- SIEMPRE POSITIVO (Constraint monto > 0)
    concepto,
    fecha,
    referencia_tipo, -- CORREGIDO: 'transferencia'
    caja_destino_id,
    notas,
    created_by
  ) VALUES (
    ...
    p_concepto,
    CURRENT_DATE,
    'transferencia', -- Valor válido según constraint
    p_caja_destino_id,
    p_notas,
    v_user_id
  );
