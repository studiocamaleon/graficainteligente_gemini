-- Migración para corregir el error: column "company_id" of relation "cajas_movimientos" does not exist
-- Se redefine la función fn_realizar_transferencia_caja eliminando la columna company_id de los INSERT.
