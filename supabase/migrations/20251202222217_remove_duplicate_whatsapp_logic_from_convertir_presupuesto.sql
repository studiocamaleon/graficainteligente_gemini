/*
  # Eliminar lógica duplicada de notificación WhatsApp

  ## Problema
  La función fn_convertir_presupuesto_a_orden tiene lógica duplicada
  para enviar notificación WhatsApp que ahora está manejada por el
  trigger trigger_notify_nueva_orden.

  ## Solución
  Eliminar el código de notificación WhatsApp de la función.
  El trigger se encargará automáticamente al hacer INSERT.

  ## Cambios
  - Remover variables de WhatsApp
  - Remover bloque BEGIN/EXCEPTION de notificación
...
BEGIN
  ...
  -- Crear orden (el trigger enviará notificación WhatsApp automáticamente)
...
La notificación WhatsApp se envía automáticamente por el trigger trigger_notify_nueva_orden.';
