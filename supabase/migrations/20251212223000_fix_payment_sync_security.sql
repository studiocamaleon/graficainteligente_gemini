-- Description: Updates the payment sync function to use SECURITY DEFINER.
-- This is a fix for the previous migration (20251212220000) which lacked SECURITY DEFINER, preventing the DELETE trigger from working due to RLS.
