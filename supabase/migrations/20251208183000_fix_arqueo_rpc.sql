-- Migración para corregir el error: INSERT has more expressions than target columns
-- en la función fn_realizar_arqueo_caja.
-- Se limpia la lógica del INSERT de cajas_movimientos.
