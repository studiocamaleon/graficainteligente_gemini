-- Migración para corregir violación de constraint "cajas_movimientos_monto_check"
-- El campo monto debe ser siempre positivo. Se elimina el signo negativo en el insert de egreso.
...
BEGIN
  ...
  INSERT INTO cajas_movimientos (
    ...
    p_monto, -- CORREGIDO: valor positivo
    p_concepto,
    CURRENT_DATE,
