-- =============================================
-- MIGRATION: 20251207233000_restore_wip_visibility.sql
-- Description: Removes the aggressive filtering of WIP orders based on client current account status to ensure visibility.
-- =============================================
...
BEGIN
    ...
    movements AS (
        ...
        WHERE company_id = p_company_id
          ...
          -- Removed aggressive filtering of clients with current account to ensure visibility
    ),
    daily_agg AS (
        SELECT 
            c.fecha,
