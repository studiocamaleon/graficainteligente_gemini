/*
  # Fix: Usar orden_id en lugar de orden_trabajo_id para archivos
  
  ## Problema
  La tabla ordenes_trabajo_archivos usa orden_id, no orden_trabajo_id
  
  ## Solución
  Corregir el INSERT de archivos para usar el campo correcto
*/
...
BEGIN
  ...
  IF p_copiar_archivos THEN
    -- USAR orden_id, no orden_trabajo_id
