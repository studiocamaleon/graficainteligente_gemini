-- Description: Fixes fn_get_cashflow_projection to exclude recurring expenses that have been manually closed in recurring_executions table.
...
BEGIN
    ...
    movements AS (
        ...
        WHERE re.company_id = p_company_id
          ...
          -- [FIX] Exclude manually closed recurring periods
          AND NOT EXISTS (
