/*
  # Fix: Usar estado 'pendiente' en conversión de presupuesto

  ## Problema
  La función usa estado 'confirmado' pero el constraint permite:
  'pendiente', 'en_proceso', 'finalizada', 'entregada', 'cancelada'

  ## Solución
  Cambiar estado a 'pendiente' al crear la orden
*/
