-- ============================================================================
-- Función: Búsqueda avanzada de presupuestos con todos los filtros (V3 - Incluye Canal)
-- ============================================================================
-- Se eliminan versiones previas para permitir el cambio de firma (RETURNS TABLE)
...
COMMENT ON FUNCTION fn_search_presupuestos_v2 IS 'Búsqueda avanzada de presupuestos incluyendo el campo canal_venta.';
