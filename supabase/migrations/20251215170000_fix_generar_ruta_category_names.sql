-- Migration: Fix Category Name Mismatches in fn_generar_ruta_produccion_item
-- Date: 2025-12-15
-- Description: Updates fn_generar_ruta_produccion_item to handle 'Impresion Gran Formato' correctly (matching DB category name).
...
BEGIN
  ...
  CASE p_categoria
    ...
    -- FIX: Accept 'Impresion Gran Formato' (Database) OR 'Gran Formato' (Legacy reference)
