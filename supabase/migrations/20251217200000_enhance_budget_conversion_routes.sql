-- =====================================================
-- ENHANCE: Budget Conversion to Copy Existing Routes (FIXED TYPES)
-- 
-- Prioritize copying routes from 'presupuestos_items_rutas'
-- also FIXED the type mapping to avoid check constraint violations.
-- =====================================================
...
BEGIN
  ...
  FOR v_item IN SELECT * FROM presupuestos_items WHERE presupuesto_id = p_presupuesto_id LOOP
    ...
    -- CORRECCIÓN: Mapear tipos de items de presupuesto a tipos de items de orden según constraints
    -- Presupuesto: producto_sistema, item_personalizado, centro_copiado
    -- Orden: catalogo, personalizado, centro_copiado
  ...
  -- 9. Notificación (mantenido por compatibilidad)
