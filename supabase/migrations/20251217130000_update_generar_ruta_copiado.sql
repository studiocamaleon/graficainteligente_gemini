-- =====================================================
-- FIX: Update Route Generation to Support "Centro de Copiado"
-- =====================================================
...
BEGIN
  ...
  -- Identified by Category name or ID
  ...
  -- B. Standard Product Lookup (Brute Force by ID)
  ...
  IF v_ruta_id IS NULL THEN
    -- If no route found, return 0 (or could warn)
    RETURN 0;
  END IF;
