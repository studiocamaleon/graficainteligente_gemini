/*
  # Fix: Agregar llamada a Edge Function en fn_convertir_presupuesto_a_orden
  
  ## Problema
  La función fn_convertir_presupuesto_a_orden no envía notificación WhatsApp
  porque el trigger automático fue eliminado pero no se agregó la llamada a Edge Function.
  
  ## Solución
  Actualizar la función para llamar a Edge Function 'enviar-notificacion-orden'
  después de crear la orden exitosamente.
  
  ## Cambios
  - Agregar 'net' al search_path para acceder a net.http_post
  - Agregar variables para HTTP request
  - Agregar bloque BEGIN/EXCEPTION con llamada a Edge Function
