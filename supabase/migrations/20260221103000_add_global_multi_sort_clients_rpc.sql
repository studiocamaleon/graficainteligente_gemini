-- Agrega orden global multi-criterio para clientes paginados.
-- Soporta p_sort_criteria como JSONB array: [{"key":"nombre_fantasia","direction":"asc"}, ...]
  ...
  RETURN QUERY EXECUTE format(
    ...
    enriched AS (
      ...
      WHERE c.company_id = $1
        ...
        AND (
          $8 = ''
          OR c.nombre_fantasia ILIKE '%%' || $8 || '%%'
          OR c.razon_social ILIKE '%%' || $8 || '%%'
