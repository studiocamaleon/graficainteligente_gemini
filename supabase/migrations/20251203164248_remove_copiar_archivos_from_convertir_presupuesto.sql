/*
  # Eliminar funcionalidad de copiar archivos en conversión de presupuestos

  1. Cambios
    - Remover parámetro `p_copiar_archivos` de la función fn_convertir_presupuesto_a_orden
    - Eliminar el bloque de código que intenta copiar archivos adjuntos
    - Actualizar documentación de la función

  2. Motivo
    - La tabla ordenes_trabajo_archivos ya no existe
    - Las órdenes de trabajo ya no manejan archivos adjuntos
    - Esto elimina el error 404 que ocurría al intentar copiar archivos
*/
